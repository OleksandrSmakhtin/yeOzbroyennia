...
struct ItemsData {
    ...
    ItemsModel(subcategory: "Повітряні сили", items: [
        "MIM-104 Patriot",
        "IRIS-T SLM",
        "FSAF SAMP/T",
        "NASAMS",
        ...
        "«Куб»",
        "«Тор»",
        "Трофейний Панцирь-С1"]),
    
    ItemsModel(subcategory: "Сухопутні війська", items: [
        "«Тор»",
        "Оса Ак, Оса АкМ",
        "AN/TWQ-1 Avenger",
        "Тунгуска",
    ...
    ItemsModel(subcategory: "Берегові ракетні комплекси", items: [
        "РК-360МЦ «Нептун»",
        "Гарпун"]),
    
    //MARK: - Інженерна техніка
    ItemsModel(subcategory: "БРЕМ", items: [
        "BPz-2",
        "БРЕМ-84",
        "БРЕМ «Лев»",
        "БРЕМ-1",
    ...
    ItemsModel(subcategory: "Інші", items: [
        "MAN TGS",
        "Biber",
        "ТММ-3М",
        "ПТС-3",
