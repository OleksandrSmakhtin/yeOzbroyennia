...
struct ItemsData {
    ...
    ItemsModel(subcategory: "Протитанкові гранатомети", items: ["C90-CR(M3)", "RGW-90 MATADOR", "AT4", "Carl Gustaf M4", "РПГ-76 «Комар»", "RPG-75", "СПГ-9", "РПГ-32", "РПГ-26", "Bullspike-AT", "РПГ-22", "РПГ-18", "РПГ-7"]),
