...
struct ItemsData {
    ...
    ItemsModel(subcategory: "Міномети", items: ["КБА-118", "М60-16 «Камертон»", "МП-60", "LMP-2017", "M2", "M57", "М224", "КБА-48М", "УПІК-82", "М120-15 «Молот»", "МП-120", "vz. 82 PRAM-L", "120 KRH 92", "Трофейний 2С12 «Сані»"]),
