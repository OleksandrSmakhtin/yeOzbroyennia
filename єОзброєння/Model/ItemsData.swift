...
struct ItemsData {
    ...
    //MARK: - Озброєння
    ItemsModel(subcategory: "Легка стрілецька зброя", items: ["5,45-мм ПСМ", "5,7-мм пістолет «Форт-28»", "7,62-мм пістолет ТТ", "9-мм пістолет Макарова (ПМ)", "9-мм пістолет «Форт-12»", "9-мм пістолет «Форт-14ТП»", "9-мм пістолет «Форт-14ПП»", "9-мм пістолет «Форт-17»", "Помпова гладкоствольна рушниця «Форт-500»", "7,62-мм самозарядний карабін Симонова (СКС)", "9-мм пістолет-кулемет «Форт-224»", "9-мм пістолет-кулемет «Форт-226»", "9-мм пістолет-кулемет «Форт-230»", "5,45-мм автомат Калашникова (АК-74)", "5,45/5,56-мм штурмова гвинтівка «Форт-221» (222, 223, 224)", "5,56 /7,62-мм штурмові гвинтівки «Форт-227 / 228 / 229»", "5,45/7,62-мм штурмова гвинтівка (автомат) «Малюк» (Вулкан-М)"]),
    
    ItemsModel(subcategory: "Снайперські гвинтівки", items: ["7,62-мм снайперська гвинтівка Драгунова (СГД)", "7,62-мм снайперська гвинтівка «Форт-301»", "7,62-мм снайперська гвинтівка ВТ APR308", "7,62-мм снайперська гвинтівка ВМ2 МП-УОС", "12,7-мм снайперська гвинтівка СГМ-12,7", "12,7-мм снайперська гвинтівка Barrett M82", "12,7-мм напівавтоматична гвинтівка Snipex .50 BMG Rhino Hunter", "12,7-мм напівавтоматична гвинтівка Snipex M75 (12,7x108)", "12,7-мм гвинтівка Snipex M100 (12,7x108)", "14,5-мм напівавтоматична гвинтівка SNIPEX 14,5", "14,5-мм далекобійна гвинтівка Snipex T-Rex", "14,5-мм далекобійна гвинтівка Snipex ALLIGATOR"]),
    
    ItemsModel(subcategory: "Кулемети", items: ["5,45-мм ручний кулемет Калашникова (РПК-74)", "5,56-мм (7,62) легкий кулемет «Форт-401»", "7,62-мм кулемет КМ-7,62 (модифікації КТ-7,62, КТМ-7,62)", "7,62-мм універсальний (єдиний) кулемет UK vz. 59"]),
    
    ItemsModel(subcategory: "Аксесуари для стрілецької зброї", items: ["Пристрій зниження рівня звуку пострілу ПЗРЗП-029", "Пристрій зниження рівня звуку пострілу ПЗРЗП-032", "Пристрій «Mega Gun»", "Приціл коліматорний ПК-1М", "Приціл коліматорний кулеметний ПКП-12,7", "Тактичний ліхтар «ЛТ-6А»", "Тактичний комплекс для кулеметника Predator 4.0", "Angel Eye: збройове дзеркало заднього огляду", "Точний лічильник набоїв від компанії Cobalt Kinetics", "Магазин з тритієвою міткою контролю залишку набоїв Elite Tactical Systems", "Подавач патрона з підсвіткою від Go Gauge Tactical", "Ложе з алюмінію для гвинтівки Мосіна", "Алюмінієвий приклад до Автомата Калашникова"]),
    
    ItemsModel(subcategory: "Ручні гранати", items: ["Ручна димова граната РДГ-2", "Ручна осколкова граната Ф-1", "Ручна осколкова граната РГ-42", "Ручна граната РГД-5, будова і принцип дії УЗРГМ (УЗРГМ-2)", "Будова і принцип дії ударно-дистанційного запалу УДЗ", "Ручні осколкові гранати РГН і РГО", "Ручна термобарична граната РГТ-16С", "Ручні термобаричні гранати РГТ-27С та РГТ-27С2", "Ручні димові гранати РДГ-55 та РДГ‐55М", "Ручна кумулятивна граната РКГ-3 (РГК-3М, РКГ-3Е, РКГ-3ЕМ)"]),
    
    ItemsModel(subcategory: "Ручні гранатомети та боєприпаси до них", items: ["30-мм ручний гранатомет РГШ-30", "40-мм ручний гранатомет РПГ-7 (РПГ-7Д)", "40-мм гранатомет «Форт-600»", "107-мм переносний реактивний гранатомет РК-4 «Інгул»", "30-мм гранатометний осколковий постріл ВОГ-40В", "40-мм гранатометний осколково-фугасний постріл V40х46", "40-мм гранатометний осколково-фугасний постріл V40x53"]),
    ...
    ItemsModel(subcategory: "Міни", items: ["Міна сигнальна звуко-світлова СМ-У", "Уніфікована димова шашка УДШ-У"]),
