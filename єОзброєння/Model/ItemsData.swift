...
struct ItemsData {
    ...
    ItemsModel(subcategory: "Кулемети", items: ["5,45-мм ручний кулемет Калашникова (РПК-74)", "5,56-мм (7,62) легкий кулемет «Форт-401»", "7,62-мм кулемет КМ-7,62 (модифікації КТ-7,62, КТМ-7,62)", "7,62-мм універсальний (єдиний) кулемет UK vz. 59/59L"]),
